...
class PastTitleScreen extends BaseWidget<PastTitleVM>{
  const PastTitleScreen({super.key});

  @override
  Widget buildUI(BuildContext context, PastTitleVM viewModel) {
    return Scaffold(
      extendBody: true,
      ...
      body: SafeArea(
          child:SingleChildScrollView(
            child:Padding(
                ...
                child:Align(
                    child:Form(key:viewModel.pastTitle,
                      child:Column(
                        children: [
                          Text(strTitle,
                              style: TextStyle(
