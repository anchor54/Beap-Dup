...
class PastConfirmHabit extends BaseWidget<PastConfirmHabitVM>{
  const PastConfirmHabit({super.key});

  @override
  Widget buildUI(BuildContext context, PastConfirmHabitVM viewModel) {
    return Scaffold(
        extendBody: true,
