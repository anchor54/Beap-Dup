...
class PastFrequentScreen extends BaseWidget<PastFrequentVM>{
  const PastFrequentScreen({super.key});

  @override
  Widget buildUI(BuildContext context, PastFrequentVM viewModel) {
    return Scaffold(
        extendBody: true,
