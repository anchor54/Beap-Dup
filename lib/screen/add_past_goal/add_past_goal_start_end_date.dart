...
class PastStartEndDateScreen extends BaseWidget<PastStartEndDateVM>{
  const PastStartEndDateScreen({super.key});

  @override
  Widget buildUI(BuildContext context, PastStartEndDateVM viewModel) {
    return Scaffold(
      extendBody: true,
