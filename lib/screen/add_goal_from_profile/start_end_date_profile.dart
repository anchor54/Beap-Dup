...
import '../../view_model/add_goal_from_profile_vm/start_end_date_profilevm.dart';
import '../../view_model/add_goal_from_profile_vm/start_end_date_profilevm.dart';
import '../../view_model/add_goal_from_profile_vm/start_end_date_profilevm.dart';
import '../../widgets/base_widget.dart';

class StartEndDateProfileScreen extends BaseWidget<StartEndDateProfileVM>{
  const StartEndDateProfileScreen({super.key});

  @override
  Widget buildUI(BuildContext context, StartEndDateProfileVM viewModel) {
    return Scaffold(
      extendBody: true,
