...
class ActiveConfirmHabit extends BaseWidget<ActiveConfirmHabitVM>{
  const ActiveConfirmHabit({super.key});

  @override
  Widget buildUI(BuildContext context, ActiveConfirmHabitVM viewModel) {
    return Scaffold(
        extendBody: true,
