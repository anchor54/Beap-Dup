...
class ActiveTitleScreen extends BaseWidget<ActiveTitleVM>{
  const ActiveTitleScreen({super.key});

  @override
  Widget buildUI(BuildContext context, ActiveTitleVM viewModel) {
    return Scaffold(
      extendBody: true,
      ...
      body: SafeArea(
          child:SingleChildScrollView(
            child:Padding(
                ...
                child:Align(
                    child:Form(key:viewModel.activeTitle,
                      child:Column(
                        children: [
                          Text(strTitle,
                              style: TextStyle(
