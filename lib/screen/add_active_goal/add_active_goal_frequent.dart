...
class ActiveFrequentScreen extends BaseWidget<ActiveFrequentVM>{
  const ActiveFrequentScreen({super.key});

  @override
  Widget buildUI(BuildContext context, ActiveFrequentVM viewModel) {
    return Scaffold(
        extendBody: true,
